...
from url import Fetcher, AioHttpFetcher, filter_http_links
from pool import UrlPool
from crawler import SyncCrawler, AsyncCrawler, extract_links
...
def test_fetcher_can_fetch():
    responses.add(responses.GET, 'http://example.com',
                  body='<html><body>Test</body></html>', status=200)
...
def test_synccrawler_can_crawl():
    ...
    responses.add(responses.GET, 'http://example.com',
                  body='<html><a href="http://example.com/page2">Link</a></html>',
                  status=200)

    # Mock second URL
    responses.add(responses.GET, 'http://example.com/page2',
...
def test_crawler_with_multiple_links():
    ...
    for i in range(1, 4):
        responses.add(responses.GET, f'http://example.com/page{i}',
                      body='<html></html>', status=200)
